...
export declare type Hook<C, T> = (context: C, request: T) => T | Promise<T>;
/**
 * Initialize Hook
 *
 ...
 */
export declare type InitializeHook<Codec extends Codecs = Codecs> = Hook<HookContext<Codec>, InitializeOptions<Codec>>;
/**
 * Request Hook
 *
 ...
 */
export declare type RequestHook<Codec extends Codecs = Codecs> = Hook<HookContext<Codec>, RequestOptions>;
/**
 * Prepare Hook
 *
 * This is invoked after the Request Hook. It will receive:
 */
export declare type PrepareHook<Codec extends Codecs = Codecs> = Hook<HookContext<Codec>, PrepareOptions<Codec>>;
